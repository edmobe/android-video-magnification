...
Java_com_example_videomagnification_magnificators_MagnificatorGdownIdeal_amplify_1spatial_1gdown_1temporal_1ideal(
        JNIEnv *env, jobject thiz, jstring video_in, jstring out_dir, jdouble alpha, jint level,
        jdouble fl, jdouble fh, jdouble sampling_rate, jdouble chrom_attenuation) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_videomagnification_magnificators_MagnificatorLpyrIdeal_amplify_1spatial_1lpry_1temporal_1ideal(
